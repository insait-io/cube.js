...
class TeradataFilter extends schema_compiler_1.BaseFilter {
...
class TeradataQuery extends schema_compiler_1.BaseQuery {
    newFilter(filter) {
        return new TeradataFilter(this, filter);
    }
    // Teradata Time-to-Time conversion
    convertTz(field) {
        return `CAST(${field} AS TIME AT TIME ZONE ${this.timezone})`;
    }
    //  TODO
...
exports.TeradataQuery = TeradataQuery;
//# sourceMappingURL=TeradataQuery.js.map